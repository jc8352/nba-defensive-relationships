...
with open(root / 'data' / 'team_defense_advanced_2023.json') as file:
...
with open(root / 'data' / 'team_wide_open_shots_2023.json') as file2:
...
with open(root / 'data' / 'team_open_shots_2023.json') as file3:
...
with open(root / 'data' / 'opponent_2023.csv', 'w') as file:
